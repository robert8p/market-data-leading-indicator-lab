...
class Settings(BaseSettings):
    ...
    capture_window_before_minutes: int = Field(default=60, ge=5, le=360, alias="CAPTURE_WINDOW_BEFORE_MINUTES")
    ...
    crypto_stream_max_dynamic_targets: int = Field(default=30, ge=1, le=200, alias="CRYPTO_STREAM_MAX_DYNAMIC_TARGETS")
    ...
    binance_pair_mode: str = Field(default="preferred_per_base", alias="BINANCE_PAIR_MODE")
